...
- 「新しい質問をする」ボタンで質問・回答欄をリセット（必要に応じて履歴保存ダイアログ表示）
- 「終了する」ボタンでアプリケーションを終了（必要に応じて履歴保存ダイアログ表示）
...
## 各バージョンの違い
| ファイル名 | テキスト | 画像添付 | 会話履歴 | 履歴保存 | 履歴再開（復元） |
|:---|:---:|:---:|:---:|:---:|:---:|
...
5. 「新しい質問をする」ボタンで新しい質問を開始（必要に応じて履歴保存ダイアログが表示されます）
6. 「終了する」ボタンでアプリケーションを終了（必要に応じて履歴保存ダイアログが表示されます）
...
6. 「新しい質問をする」ボタンで新しい質問を開始（画像もリセット、必要に応じて履歴保存ダイアログが表示されます）
7. 「終了する」ボタンでアプリケーションを終了（必要に応じて履歴保存ダイアログが表示されます）
